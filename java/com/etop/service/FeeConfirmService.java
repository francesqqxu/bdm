...
public class FeeConfirmService {
		...
		public PageUtil<FeeConfirmDto> getFeeConfirmSponsor(String order, int page, int rows, String sort, String feeDate){
		    ...
		    if(feeConfirmNum == 0 ){
	     	    ...
	     	    log.info(args[0].toString());
					...
					String countSql = "select count(*)  from t_broadband  where  stopDate is null and (settlementCycle = 1 or( (paymentMonth + settlementCycle) % :MONTHPERYEAR) = :iMonth "
							+ "  or (settlementCycle = 12 and paymentMonth = :iMonth))";
	...
	public Object addFeeConfirmSponsor(String feeDate){
	    ...
	    log.info(feeDate);
		    ...
		    int  iMonth = Integer.parseInt(feeDate.substring(4,6));
		    if(feeConfirmNum == 0 ){
			    args = new Object[]  {feeDate, MONTH_PER_YEAR, iMonth, iMonth};
    ...
    public Object updateConfirm(String ids){
    	log.info(ids);
    ...
    public PageUtil<FeeConfirmReportDto> getFeeConfirmReport(String order, int  page, int rows, String sort, String dateFrom, String dateTo, String notConfirmed) {
		String sql = "";
		int  first = rows * ( page -1 );
    ...
    public List<FeeConfirmReport> getFeeConfirmReportList(String dateFrom, String dateTo){
...
//    						+ sWhere +  " order by a.broadbandId ";
    			...
    			String sql = " select id,   broadbandId,   city,  status,  payOrganization   "
