...
public class FeeConfirmController extends BaseController{
	...
	@ResponseBody
	public Object confirm(String ids){
		log.info("confirm.html");
		return feeConfirmService.updateConfirm(ids);
	}
	...
	public Object get_feeConfirmReport(@RequestParam("order") String order, @RequestParam("page") int page, @RequestParam("rows") int rows,
			@RequestParam("sort") String sort,	@RequestParam("dateFrom") String dateFrom , @RequestParam("dateTo") String dateTo, @RequestParam("confirmed") String notConfirmed) {
		log.info("/get_feeConfirmReport.html");
		log.info("dateFrom" + dateFrom);
		log.info("dateTo" + dateTo);
		return  feeConfirmService.getFeeConfirmReport( order, page, rows, sort, dateFrom, dateTo, notConfirmed);
	}
	...
	public  String exportFeeConfirm(ModelMap mm,@RequestParam("dateFrom") String dateFrom,
		  ...
		  mm.addAttribute("list",feeConfirmService.getFeeConfirmReportList(dateFrom, dateTo));
